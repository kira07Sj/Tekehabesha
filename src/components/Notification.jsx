...
const Notification = ({success,warning,warning2,yesBtnOnClick, noBtnOnClick}) => {
  ...
  return (
    <div className={` flex items-center flex-col justify-start w-[300px] h-[250px] rounded-md bg-light-brown
     shadow-md lg:right-1/2 lg:absolute`} data-aos="fade-down" >
        ...
        <h1 className={`${warning2} text-brown text-[1.2rem] font-bold text-center p-4`}>Incorrect username or password please use try again</h1>
